...
public class nq3 extends AppCompatActivity {
    Button questionOneP, questionOneA, questionOneE, questionOneY, questionOneS;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nq3);
        addListenerOnButton();
    }
    public void addListenerOnButton() {
        questionOneA = (Button) findViewById(R.id.q3n1);
        questionOneA.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                Count.npCount = Count.npCount + 1;
                Intent intent = new Intent(nq3.this, nq4.class);
                startActivity(intent);
            }
        });
        questionOneY = (Button) findViewById(R.id.q3n2);
        ...
        questionOneE = (Button) findViewById(R.id.q3n3);
        ...
        questionOneP = (Button) findViewById(R.id.q3n4);
        ...
        questionOneS = (Button) findViewById(R.id.q3n5);
